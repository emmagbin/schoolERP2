...
<div class="layout-main">
                        ...
                        <li class="sidenav-item ">
                            <a href="#" aria-haspopup="true">
                                ...
                                <span class="sidenav-label" style="font-size: 11px"
                                      data-toggle="modal" data-target="#YourOrder"
                                    >Your Order</span>
                            </a>
                        </li>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="col-md-12">
                            <br>
                            <center>
                                <img  id="lloading" src="assets/images/294.gif" style="display: none;  "/>
                        ...
                        <div class="card-body">
                            <table id="demo-datatables-responsive-1" class="table table-bordered table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 12px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!--                                            --><?php //echo $Weekly_order['0']['Monday'];?>
                                        <?php echo $Weekly_Monday;?>



                                    </td>
                                    <td> <center>
                                            <button class="editde btn  btn-warning" style = "text-transform: capitalize;
                                            background-color: goldenrod; ; border-color: goldenrod"
                                                    type="button" data-toggle="modal" data-target="#EditMonday"
                                                    data-weeklymonday="<?php echo $Weekly_Monday;?>"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $Weekly_Tuesday;?>
                                    </td>
                                    <td> <center>
                                            <button class="tuesdayEdit btn  btn-warning" style = "text-transform: capitalize;
                                            background-color: goldenrod; ; border-color: goldenrod"
                                                    type="button" data-toggle="modal" data-target="#EditTuesday"
                                                    data-weeklytuesday="<?php echo $Weekly_Tuesday;?>"
                                                    data-email="<?php echo $email;?>" >
                                                <i class = "icon icon-edit"></i>
                                            </button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $Weekly_Wednesday;?>
                                    </td>
                                    <td> <center>

                                            <button class="wednesdayEdit btn  btn-warning" style = "text-transform: capitalize;
                                                 background-color: goldenrod; ; border-color: goldenrod"
                                                    type="button" data-toggle="modal" data-target="#EditWednesday"
                                                    data-weeklywednesday="<?php echo $Weekly_Wednesday;?>"
                                                    data-email="<?php echo $email;?>" >
                                                <i class = "icon icon-edit"></i>
                                            </button>
                                        </center>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $Weekly_Thursday;?>
                                    </td>
                                    <td> <center>
                                            <button class="thursdayEdit btn  btn-warning" style = "text-transform: capitalize;
                                                 background-color: goldenrod; ; border-color: goldenrod"
                                                    type="button" data-toggle="modal" data-target="#EditThursday"
                                                    data-weeklythursday="<?php echo $Weekly_Thursday;?>"
                                                    data-email="<?php echo $email;?>" >
                                                <i class = "icon icon-edit"></i>
                                            </button>
                                        </center>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $Weekly_Friday;?>
                                    </td>
                                    <td> <center>
                                            <button class="fridayEdit btn  btn-warning" style = "text-transform: capitalize;
                                                 background-color: goldenrod; ; border-color: goldenrod"
                                                    type="button" data-toggle="modal" data-target="#EditFriday"
                                                    data-weeklyfriday="<?php echo $Weekly_Friday;?>"
                                                    data-email="<?php echo $email;?>" >
                                                <i class = "icon icon-edit"></i>
                                            </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-tabs">
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="display2">
                            <form action="Service_Category_Controller/update_monday" method="post">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label  class="form-label" style="font-size: 12px">Monday</label>
                                            <input id="MondayOrder" class="form-control" type="text" style="font-size: 11px"
                                                   name="EditMonday" required="">
                                            <input  class="form-control" type="text" style="font-size: 11px" value=" <?php echo $email;?>"
    ...
    <div id="EditTuesday" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="background-color: #217345">
                    <button type="button" class="close" data-dismiss="modal" style="color: #fff" >
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label  class="form-label" style="font-size: 12px">Tuesday</label>
                                            <input id="TuesdayOrder" class="form-control" type="text" style="font-size: 11px" name="EditDay" required="">
                                        </div>
                                    </div>
                                </div>
                                <hr style="border-color:#217345">
    ...
    <div id="EditWednesday" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="background-color: #217345">
                    <button type="button" class="close" data-dismiss="modal" style="color: #fff" >
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label  class="form-label" style="font-size: 12px">Wednesday</label>
                                            <input id="WednesdayOrder" class="form-control" type="text" style="font-size: 11px" name="EditDay" required="">
                                        </div>
                                    </div>
                                </div>
                                <hr style="border-color:#217345">
    ...
    <div id="EditThursday" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="background-color: #217345">
                    <button type="button" class="close" data-dismiss="modal" style="color: #fff" >
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label  class="form-label" style="font-size: 12px">Thursday</label>
                                            <input id="ThursdayOrder" class="form-control" type="text" style="font-size: 11px" name="EditDay" required="">
                                        </div>
                                    </div>
                                </div>
                                <hr style="border-color:#217345">
    ...
    <div id="EditFriday" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="background-color: #217345">
                    <button type="button" class="close" data-dismiss="modal" style="color: #fff" >
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label  class="form-label" style="font-size: 12px">Friday</label>
                                            <input id="FridayOrder" class="form-control" type="text" style="font-size: 11px" name="EditDay" required="">
                                        </div>
                                    </div>
                                </div>
                                <hr style="border-color:#217345">
