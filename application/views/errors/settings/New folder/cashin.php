               ...
               <ul class="sidenav">
                  ...
                  <li class="sidenav-item">
                      <a href="cashin" aria-haspopup="true" style="background-color: darkgoldenrod;">
                          ...
                          <span class="sidenav-label" style="font-size: 11px; color: #fff" >Collections Cash-In</span>
                      </a>
                  </li>
        ...
        <div class="layout-content-body">
          <div class="title-bar">
            ...
            <h1 class="title-bar-title">
              <span class="d-ib">Agents Cash-IN</span>
            </h1>
                                  ...
                                  <div class="row" style="border-left:5px solid #000">
                                      <div class="col-md-5">
                                          <div class="panel-heading">
                                              ...
                                              <h4 style="font-family: Calibri">Search By Agent's Phone Number</h4>
                                          </div>
                                      </div>
...
<br>
                                          <div class="row">
                                              ...
                                              <div class="col-md-6">
                                                  <label  class="form-label" style="font-size: 12px">A/C Balance</label>

                                                  <input id="accountbalance" class="form-control" type="text" style="font-size: 11px" readonly></div>
            ...
            //alert(phonenumber);
                ...
                e.preventDefault();
                         ...
                         $.ajax({
                            ...
                            url:'<?php echo site_url('DataUtilitiesController/phonenumbersearch'); ?>',
              ...
              else
              {
                ...
                e.preventDefault();
                         ...
                         $.ajax({
                            ...
                            url:'<?php echo site_url('DataUtilitiesController/payInCash'); ?>',
                            success:function(result)
                            {
                             // alert(result);
