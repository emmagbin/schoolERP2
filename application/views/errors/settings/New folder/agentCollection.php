                    ...
                    <div class="demo-form-wrapper">
                        <form class="form form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <input id="datefrom"  class="form-control" type="date" style="font-size: 11px">
                            </div>

                            <div class="form-group">
                                <label  class="form-label" style="font-size: 11px"><u>Date (To)</u></label>
                                <input id="dateto" class="form-control" type="date" style="font-size: 11px">
                            </div>
                             <div class="form-group">
                      <label for="form-control-31" class="form-label" style="font-size: 11px"><u>Collection Agent</u></label>
                      <select id="agentname" name="role" class="form-control" style="font-size: 11px">
                           <option value="" class="form-control" disabled="" selected="" >--select Agent</option>
                           <option value="ALL" class="form-control" >ALL</option>
                                     <?php foreach($agents as $record):?>
                                                       
                                    <option value="<?php echo $record->suspenseAccountNumber;?>"><?php echo $record->accountName;?></option>
                                    <?php endforeach;?>
                                </select>
                    ...
                    <div class="col-md-12">
                        <div class="panel m-b-lg">
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li><a href="#profile-11" data-toggle="tab"><i class ="icon icon-list-ol"></i> Grid View Of Records <span id="statementFromTO" style="color:red; font-family: Verdana; font-size: 11px "></span></a></li>
   ...
   if((datefrom=="") ||(dateto=="") ||(agentname==""))
            ...
            else
            {
                e.preventDefault();
                         ...
                         $.ajax({
                            type:'POST',
                            data:{datefrom:datefrom,dateto:dateto,agentname:agentname,userEmail:userEmail },
                            url:'<?php echo site_url('agentCollectionController/agentscollectionreport'); ?>',
                            success:function(result)
                            {
                               $("#loading").hide();
                                //alert(result);
                               $('#emptySearchFields').html(" ");
...
<script type="text/javascript">
  ...
  doc.save("Agent Collections.pdf");
}
</script>
