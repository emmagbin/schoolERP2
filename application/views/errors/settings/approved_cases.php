                    ...
                    <ul class="sidenav">
                        ...
                        <?php if($user_role=='3'){?>
                            <li  >
                                <a href="#" aria-haspopup="true">
                                    <span class="sidenav-icon fa fa-folder-open-o"></span>
                        ...
                        <li class="sidenav-item">
                            <a href="pending_case" aria-haspopup="true">
                                <span class="sidenav-icon fa fa-refresh fa-spin"></span>
                        ...
                        <?php if($user_role=='1'){?>
                            <li class="sidenav-item active">
                                <a href="approved_case" aria-haspopup="true">
                                    <span class="sidenav-icon fa fa-thumbs-o-up"></span>
                            ...
                            <div class="col-md-6">
                                <div class="card" style="background-color: #217345; color: #fff">
                                    <div class="card-values">
                                        <div class="p-x">
                                            <small>Total Cases Approved <i class="fa fa-refresh fa-spin" style = "color: #fff"></i></small><br><br>
...
////hrefs picking the transaction id and case id for selecting the required data     
    });
...
<script>
 $(document).on('click','#hreflink',function(e) {
        ...
        $.ajax({
            ...
            url:'<?php echo site_url('approved_case_controller/select_description'); ?>',
                ...
                $.each(data,
                    function (index, item) {
                       if(item.coo_comment == null){
                            ...
                            '<br>'+'' +'<span style="font-weight: bold">Complain :</span>'+' '+item.descriptions+'' + 
...
<!--//////////////////fetchinfo PICKING DATA STARTS HERE ////////////////-->
<script>
...
<!--//////////////////fetchinfo PICKING DATA ENDS HERE ////////////////-->

<!--//////////////////FUNCTION FOR ADDING COMMAS TO EVERY THREE DIGIT FIGURE ////////////////-->
<script>
...
<!--////SELECTING A TRANSACTION STARTS HERE//////////////////-->
<script>
...
<!--////////////////SELECTING A TRANSACTION ENDS HERE//////////////////-->


<!--//////////////////SELECTING A DESCRIPTION STARTS HERE/////////////////////////////-->
<script>
    $(document).on('click','#trans',function(e) {
        var transaction_id= $('#transaction_id').val();
        //alert(transaction_id)
...
<!--////////////////////////////DESCRIPTION DELECTION STARTS HERE///////////////////////-->
<script>
    $(document).on('click','#trans_case_open',function(e) {
        var transaction_id= $('#transaction_id_case_open').val();
        //alert(transaction_id)
