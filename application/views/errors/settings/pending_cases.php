            ...
            <div class="custom-scrollbar" >
                <nav id="sidenav" class="sidenav-collapse collapse" style="background-color: #217345; color: #fff">
                    <ul class="sidenav">
                        ...
                        <?php if($user_role=='1'){?>
                            <li class="sidenav-item">
                                <a href="approved_case" aria-haspopup="true">
                                    <span class="sidenav-icon icon icon-edit"></span>
                                    <span class="sidenav-label" style="font-size: 11px">Approved Cases</span>
                                </a>
                            </li>
                        <?php }?>
                        <li class="sidenav-item">
                            ...
                            <div class="col-md-6">
                                <div class="card" style="background-color: #217345; color: #fff">
                                    <div class="card-values">
                                        <div class="p-x">
                                            <small>Total Cases Pending <i class="fa fa-refresh fa-spin" style = "color: #fff"></i></small><br><br>
...
<!--                                        <td>--><?php //echo $record->transaction_id;?><!--</td>-->
                                        ...
                                        <td><?php echo $record->transaction_id;?>
                                           
                                        </td>
                                        <td><a href='#' id="hreflink" 
                                            data-transaction_id="<?php echo $record->transaction_id;?>" 
                                            data-case_id="<?php echo $record->case_id;?>"><?php echo $record->case_id;?>
                                            </a>
                                        <td>
                                            <center>
...
<!--                                        <button id="buttoogle" class="btn btn-primary" style="background-color: #217345;float:right;margin-top: 5px">hid/ show</button>-->
                        ...
                        <?php if($user_role=='1'){?>
                        <form method="post" action="pending_cases_controller/add_comment">
                            <input type="hidden" name="coo_name" id="my_full_name" value="<?php echo $user_full_name;?>">
                            <input id="caseid_num" type="hidden" name="case_number"/>
                            <textarea  id="comment" name="comment" class="form-control" style="min-height:100px"></textarea >

                            <button type="submit"  class="btn btn-primary" style="background-color: #217345;margin-left: 390px;margin-top: 5px">Approve</button>
...
<script>
    $(document).on('click','#fetchinfo',function(){
        $('#caseid_num').val($(this).data('case_id'));
...
<script>
    $(document).on('click','#decline',function(e) {
       var case_id= $('#caseid_num').val();
        var coo_comment= $('#comment').val();
        var coo_name= $('#my_full_name').val();
        if(comment=="")
        {        }
        else
        {
            ...
            $.ajax({
                type:'POST',
                data:{case_id:case_id,coo_comment:coo_comment,coo_name:coo_name},
                url:'<?php echo site_url('pending_cases_controller/decline'); ?>',
...
<script>
    $(document).on('click','#hreflink',function(e) {
       ...
       // alert('href');
        ...
        $.ajax({
            ...
            url:'<?php echo site_url('pending_cases_controller/select_description'); ?>',
            success:function(result)
            {
                //alert(result);
                data = JSON.parse(result);
                $('#description_old_once').empty();
                var $select_using_href=$('#description_old_once');
                $.each(data,
                    function (index, item) {
                        $select_using_href.append($('<tr> <td> <p>' +
                            ...
                            '<span style="font-weight: bold">CS Staff :</span>'+''+item.cs_name+'</p></td> </tr><tr>  <td> <p>' +
                            '<span style="font-weight: bold">Compliance Name :</span>'+' '+item.c_compliance_name+''+'<br>'+
                            '<span style="font-weight: bold">Comment From Compliance :</span>'+' '+item.c_comment+''+'<br>'+
                            '<span style="font-weight: bold">Date Submited :</span>'+' '+item.c_time_date+'</p></td> </tr>'))
                    }
                );
                $('#top_of_modal').empty();
                var $top_of_modal_for_href=$('#top_of_modal');
                $.each(data,
                    function (index, item) {
                        $top_of_modal_for_href.append($('<tr> <td> <p>' +
                 ...
                 $('#caseid_num1').empty();
                var $caseid_num_for_href=$('#caseid_num1');
                $.each(data,
                    function (index, item) {
                        $caseid_num_for_href.append($('<tr> <td> <p>'+item.case_id+' </p></td>  </tr>'))
                    }
                );
    ...
    $(document).on('click','#hreflink',function(e) {
        ...
        $.ajax({
            ...
            url:'<?php echo site_url('pending_cases_controller/select_a_transaction'); ?>',
            success:function(result)
            {
...
<!--//////////////////FECTINFO ICON PICKING THE TRANSACTION ID AND CASE ID FOR SELECTING THE REQIURED DATA ////////////////-->
<script>
        ...
        $.ajax({
            ...
            success:function(result)
            {
                ...
                $.each(data,
                 ...
                 $('#caseid_num1').empty();
                var $caseid_num1=$('#caseid_num1');
                $.each(data,
                    function (index, item) {
                        $caseid_num1.append($('<tr> <td> <p>'+item.case_id+' </p></td>  </tr>'))
                    }
                );
...
<!--//////////////////ADDING COMMAS TO EVERY THEEE DIGIT VALUES ////////////////-->
<script>
                ...
                $.each(data,
                    function (index, item) {
                        $select.append($('<tr> <td> <p>' +
                            ...
                            '<span style="font-weight: bold">Comment :</span>'+' '+item.CaseStatus+''+'<br>'+
                            '<span style="font-weight: bold">Approval Date :</span>'+' '+item.CaseStatus+''+'<br>'+
