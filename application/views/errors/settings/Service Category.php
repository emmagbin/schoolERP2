...
<head>
    ...
    <!-- <script src="assets/auto_logout.js"></script> -->
                ...
                <nav id="sidenav" class="sidenav-collapse collapse" style="background-color: #217345; color: #fff">
                    <ul class="sidenav">
                        ...
                        <li class=" sidenav-item  ">
                            <a href="placeorder" aria-haspopup="true">
                                <span class="sidenav-icon icon icon-edit"></span>
                                <span class="sidenav-label" style="font-size: 11px">Your Order</span>
                            </a>
...
<!--                            </li>-->
    ...
    <div class="row">
        <div class="col-xs-12" >
           <center> <img class="overlay-brand" src="assets/img/lunch.png"
                 data-src="assets/img/logo.png" data-src-retina="assets/img/lunch.png" width="50%" height="80%"></center>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-tabs">
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="display2">
                        <button id="buttoogle" class="btn btn-primary" style="background-color: #217345;float:right">hide/show</button>
                        <br>  <br>
                        <form id="toogle">
                            <div class="col-md-12">
                ...
                $.each(data,
                    function (index, item) {
                        $select.append($('<tr> <td> <p>' +
                            ...
                            ' &nbsp &nbsp ' +'<span style="font-weight: bold;color:red">Case ID :</span>'+' '+item.case_id+'' + '<br>'+
                            '<span style="font-weight: bold;color:red">Complainant Name :</span>'+' '+item.complainant_name+
                            ' &nbsp &nbsp ' +'<span style="font-weight: bold;color:red">Complainant Contact :</span>'+' '+item.complainant_contact+''+'<br>'+
                            '<span style="font-weight: bold;color:red">Complain :</span>'+' '+item.descriptions+''+'<br>'+
                            '<span style="font-weight: bold;color:red">Case Status :</span>'+' '+item.CaseStatus+'</p></td>  </tr>'))
                    }
                );
            }
        });
