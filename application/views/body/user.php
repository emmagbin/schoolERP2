                          ...
                          <table id="demo-datatables-responsive-1" class="table table-bordered table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 12px">
                              ...
                              <tr>
                                   <td>
                                        ...
                                        <td>
                                            <?php echo strtoupper($record->created_date);?>
                                        </td>
                                        <td>
                                            <?php echo strtoupper($record->gender);?>
                                        </td>
                                        <td>
                                            <?php echo strtoupper($record->role);?>
                                        </td>
...
<button class="btn  btn-warning" id="bntedit" style = "text-transform: capitalize; background-color: #686EE4; ; border-color: #686EE4"  type="button" data-toggle="modal" data-target="#editUser" 
                                      data-usersid="<?php echo $record->users_id;?>"
                                      ...
                                      data-phone="<?php echo $record->phone;?>"> <i class = "icon icon-edit"></i></button>
                                          | 
                                           <?php if($record->status=='A'){?>
<button class="btn  btn-warning" id="btnlock" style = "text-transform: capitalize; background-color: black; ; border-color: black"  type="button" data-toggle="modal" data-target="#disUser" data-usersid="<?php echo $record->users_id;?>"
                                      data-email="<?php echo $record->email;?>"
                                      data-fullname="<?php echo $record->fullname;?>"
                                      data-gender="<?php echo $record->gender;?>"
                                      data-role="<?php echo $record->role;?>"
                                      data-phone="<?php echo $record->phone;?>" > <i class = "icon icon-lock"></i></button> | 
                                          <?php }?>
                                           <?php if($record->status=='D'){?>
<button class="btn  btn-warning" id="btnunlock" style = "text-transform: capitalize;  background-color: maroon; border-color: maroon"  type="button" data-toggle="modal" data-target="#anableUser" data-users_id="<?php echo $record->users_id;?>"
                                      data-email="<?php echo $record->email;?>"
                                      data-fullname="<?php echo $record->fullname;?>"
                                      data-gender="<?php echo $record->gender;?>"
                                      data-role="<?php echo $record->role;?>"
                                      data-phone="<?php echo $record->phone;?>" > <i class = "icon icon-unlock"></i></button>
                                          
                                          | <?php }?>
<button class="btn  btn-warning" id="btndelete" style = "text-transform: capitalize;  background-color: maroon; border-color: maroon"  type="button" data-toggle="modal" data-target="#delUser" data-users_id="<?php echo $record->users_id;?>"
                                      data-email="<?php echo $record->email;?>"
                                      data-fullname="<?php echo $record->fullname;?>"
                                      data-gender="<?php echo $record->gender;?>"
                                      data-role="<?php echo $record->role;?>"
                                      data-phone="<?php echo $record->phone;?>" > <i class = "icon icon-trash"></i></button>
                                      </Center>
                                  </td>
