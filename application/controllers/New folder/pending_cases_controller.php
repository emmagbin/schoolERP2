...
class pending_cases_controller extends CI_Controller {
    ...
    public function index()
    {
        if($this->session->userdata('logged_in'))
        {
            ...
            $cases['total_cases']=$this->count_pending_cases();
            $cases['service_category_name']=$this->all_service_category();
            $this->load->view('pending_cases',$cases);
        }
        else
        {
...
//         $result_row=$query->num_rows();
    ...
    {
        $query= $this->db->query("select case_id,transaction_id from case_description where CaseStatus='Pending'");
        $cases= $query->result();
        return $cases;
    }
...
where case_description.transaction_id='$transaction_id' and compliance_comment.c_case_id='$case_id'");
    ...
    public function select_a_descriptions_for_check_status()
    {
        ...
        $query_description= $this->db->query("select * from case_description where cast (time_date as date) = '$time_date' and transaction_id='$transaction_id'");
        $data=$query_description->result_array();
        echo json_encode($data);
     ...
     public function add_comment()
    {
        ...
        $data = array(
            'coo_case_id' => $case_id,
            'coo_name' => $this->input->post('coo_name'),
            'coo_comment' => $comment,
            'coo_time_date' => date("Y-m-d H:i:s"),
             );
        $data_without_comment = array(
            'coo_case_id' => $case_id,
            'coo_name' => $this->input->post('coo_name'),
            'coo_time_date' => date("Y-m-d H:i:s"),
             );
        ...
        $this->db->insert('coo_comment', $data_without_comment);
        }
        else
        {
             //var_dump($data); die;
        ...
        $this->db->update("case_description",$data_update);
         ...
         //insert into coo_comment table
        $this->db->insert('coo_comment', $data);

        }
        redirect('pending_case');
    }
    ...
    public function decline()
    {
        ...
        $data = array(
            'coo_case_id' => $case_id,
            'coo_name' => $this->input->post('coo_name'),
            // 'coo_comment' => $this->input->post('coo_comment'),
            'coo_time_date' => date("Y-m-d H:i:s"),
        );
